--[[                                                                                                                                                                                                                                                                                  
                                                                                                                                          ...
                                                                                                                                          ?@#                                                                          P@B                                                                                                                                                                                      
                                                                                                                                          ?@P   .   ^~~.  :~!!:     :^^:.         :^~~~^.      .:^:                    J@#.^?Y5J^       .:^:.     ^~   .^:      :^:.                                                                                                                                            
                                                                                                                                          ?@5 .G&JJ#@&@#5#&&#@&~  ?B&&&&#B:     ?B&&##&@#:   ~P&&&##P!                 ?@&#@#PP@@J    ^5&&###P7  .#@5JB&&P.   7B&&&#BY^                                                                                                                                         
                                                                                                                                          ?@5 .&@@&5~.B@&J~..#@J P@#!:.!@@7   .G@B!:. ~@@!  J@&?:^7G@@Y                ?@@B!.  J@&.  ?@@J:^7G@@P  G@@&Y~:.  .G@B~:~J&@@!                                                                                                                                        
                                                                                                                                          ?@5 .&@5.   G@5   .&@?!@@^    #@Y   ?@&:    :&@7 7@@PYB#&#PY~                J@&.    J@&. ~@@PYG#&#GY!  P@B:      P@&YPB&#BPJ:                                                                                                                                        
                                                                                                                                          ?@P :@@7   .#@Y   ~@@~7@&.    Y@#.  5@#. .^?G@@7 P@@BP?~: ..                 Y@#     5@B  Y@@#PJ!: .:   G@5      .&@&G57^. ..                                                                                                                                         
                                                                                                                                          ?@B ~@@~   ^@@!   J@&..#@P^.:~5@@?  ^B@#B&&#B@@~ !@@Y^:^7P&&~                5@#     Y@#: ~&@5^:^!P&&! .#@Y       5@&7^:~JB@G.                                                                                                                                        
                                                                                                                                          7@# ~&B.   :P5.   Y@Y  :5#&#&&BP@#.   ^77~: 5@#.  ~5#&&&#P?:  .::::::^^~!7~  ~57     .P#!  ^YB&&&#G?^  .G&7        7G#&&&#5!.                                                                                                                                         
                                                                                                                                           ^:  ..            .     .:^^.  ::  :~^:::^Y@&~      .:.     !#&&&&&&&&###P.                  .:..      ..           ..:.                                                                                                                                             
                                                                                                                                                                              Y##&&&&#5^               .^^^^^^::..                                                                                                                                                                                              
                                                                                                                                                                               ..:::.                                                                                                                                                                                                                           
...
FEManager.DownloadFile(Directories.RBXMs, "YAS.rbxmx", "https://raw.githubusercontent.com/fenguy4-cmyk/un/refs/heads/main/YAS.rbxmx")
...
-------------------------------------------------------------------------------------
local script = game:GetObjects(getcustomasset("Documents/YAS.rbxmx"))[1]
----------------------------------------------------------------------------
...
local Swing = function()
	...
	CanHitbox = true
	EnableHitbox()
	local SwingAnimation = PlayAnim(Character, Animations.Swing, 2)
...
local A = function()
	...
	task.spawn(function()
		while A_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.A, 3)
			anim.Completed:Wait()
		end
...
local Ey = function()
	...
	task.spawn(function()
		while Ey_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.Ey, 3)
			anim.Completed:Wait()
		end
...
local Ban_Wave_Running = false
local Ban_Wave = function()
	if Ban_Wave_Running then
		Ban_Wave_Running = false
		RestoreMovement()
		Debounce = false
		return
	end
	...
	Ban_Wave_Running = true
	Debounce = true
	
	task.spawn(function()
		while Ban_Wave_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.Banwave, 3)
			SetWalkSpeed(3)
			anim.Completed:Wait()
		end
...
local O = function()
	...
	task.spawn(function()
		while O_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.O, 3)
			anim.Completed:Wait()
		end
...
local S = function()
	...
	task.spawn(function()
		while S_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.S, 3)
			anim.Completed:Wait()
		end
...
local G = function()
	...
	task.spawn(function()
		while G_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.G, 3)
			anim.Completed:Wait()
		end
...
local D = function()
	...
	task.spawn(function()
		while D_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.D, 3)
			anim.Completed:Wait()
		end
...
local F = function()
	...
	task.spawn(function()
		while F_Running do
			local HitHumanoids = {}
			local anim = PlayAnim(Character, Animations.F, 3)
			SetWalkSpeed(3)
			anim.Completed:Wait()
		end
...
local HAH = function()
	...
	task.spawn(function()
		while Running do
			...
			local anim = PlayAnim(Character, Animations.HAH, 3)
			SetWalkSpeed(3)
			
			-- 🔁 wait until animation ends, then instantly loop
			anim.Completed:Wait()
		end
